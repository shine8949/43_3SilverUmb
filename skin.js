...
// Filename: 3_silver_9color.ggsk
// Generated 수 10 13 10:09:39 2021
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this.__7.className='ggskin ggskin_rectangle';
		this.__7.ggType='rectangle';
		hs ='position:absolute;';
		hs+='left: 287px;';
		hs+='top:  -15px;';
		hs+='width: 21px;';
		...
		this.__7.onclick=function () {
			me.player.changeViewState("8",0);
		}
		this._controller.appendChild(this.__7);
		this.__6=document.createElement('div');
		this.__6.ggId="\uadf8\ub9b0";
		this.__6.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this.__6.ggVisible=true;
		this.__6.className='ggskin ggskin_rectangle';
		this.__6.ggType='rectangle';
		hs ='position:absolute;';
		hs+='left: 257px;';
		hs+='top:  -15px;';
		hs+='width: 21px;';
		...
		this.__6.onclick=function () {
			me.player.changeViewState("7",0);
		}
		this._controller.appendChild(this.__6);
		this.__5=document.createElement('div');
		this.__5.ggId="\uc640\uc778";
		this.__5.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this.__5.ggVisible=true;
		this.__5.className='ggskin ggskin_rectangle';
		this.__5.ggType='rectangle';
		hs ='position:absolute;';
		hs+='left: 287px;';
		hs+='top:  16px;';
		hs+='width: 21px;';
